...
public class Cuadratura_Gaussiana {
    public static void main(String[] args) {
        ...
        // Puntos y pesos para la cuadratura gaussiana de 2 puntos en [-1,1]
        double t1 = -1.0 / Math.sqrt(3.0);
        double t2 =  1.0 / Math.sqrt(3.0);
        double w1 = 1.0;
        double w2 = 1.0;

        // Transformar t a x en el intervalo [limInf, limSup]
        ...
        // Aproximación de la integral usando la cuadratura gaussiana:
        // I ≈ ((limSup - limInf)/2) * [w1 * f(x1) + w2 * f(x2)]
